...
from Settings.Program.scripts.banner import banner2,banner,clear
from Settings.Program.scripts.sprint import sprint
from Settings.Program.scripts.colors import ran,y,r,g,c
